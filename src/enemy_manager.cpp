...
Archetype BIGSLIME("common/sprites/BigSlime.png", "common/sprites/FireballNoOutline.png",			false, 1.2f, 6,    2, 4, 3, 4, Behavior::AIType::Simple,   glm::vec2(1.2f, 1.2f),	  glm::vec2(0.4f),  20);
Archetype SPIDER("common/sprites/RedSpider.png", "common/sprites/WebShot.png",						true,     1, 7,    1, 2, 3, 5, Behavior::AIType::Cardinal, glm::vec2(0.5f, 0.5f),	  glm::vec2(0.3f),  15);
...
void GenerateEnemyRoom(DungeonTile* tiles, int numTiles)
{
	...
	case 11:
		...
		case 0:
			...
			GenerateEnemy(enemies.at(10), ABNORMALGHOST);
		case 1:
			for (int i = 0; i < 9; i++) {
				GenerateEnemy(enemies.at(i), SLIME);
			}
			GenerateEnemy(enemies.at(9), BIGSLIME);
			GenerateEnemy(enemies.at(10), BIGSLIME);
		default:
			break;
		}
		break;
